...
2. **Create app** → All In One POS → default language English (U.S.) → App → Free.
3. Complete the required declarations (privacy policy, export compliance, etc.) as prompted.
4. Confirm the app will use package **`com.allinonepos.app`** (must match [`android/app/build.gradle.kts`](../../android/app/build.gradle.kts)).
