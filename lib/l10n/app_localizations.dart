...
abstract class AppLocalizations {
  ...
  /// No description provided for @accountStepCreatingAccount.
  ///
  /// In en, this message translates to:
  /// **'Creating your account'**
  String get accountStepCreatingAccount;

  /// No description provided for @accountStepAuthenticating.
  ///
  /// In en, this message translates to:
  /// **'Checking your password'**
  String get accountStepAuthenticating;

  /// No description provided for @accountStepOpeningShop.
  ///
  /// In en, this message translates to:
  /// **'Opening your shop'**
  String get accountStepOpeningShop;
  ...
  /// No description provided for @accountSwitchToRegister.
  ///
  /// In en, this message translates to:
  /// **'New here? Create an account'**
  String get accountSwitchToRegister;
